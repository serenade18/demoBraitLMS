...
use App\Http\Controllers\Panel\CertificateFeeController;
use App\Http\Controllers\Panel\WebinarCertificateController;
...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::group(['prefix' => 'course'], function () {
        ...
        Route::get('/{slug}/free', 'WebinarController@free')->name('webinar.free');
    ...
    Route::get('/certificates/fee/{certificateId}', [CertificateFeeController::class, 'showPaymentPage'])->name('certificates.fee');
    Route::get('/certificates/download/{certificateId}', [WebinarCertificateController::class, 'showCourseCertificate'])->name('certificates.download');

    Route::get('/certificate/{id}/pay', [CertificateFeeController::class, 'showPaymentPage'])->name('certificates.showPaymentPage');

Route::post('/certificate/{id}/process-payment', [CertificateFeeController::class, 'processPayment'])->name('certificates.processPayment');

Route::get('/certificate/payment/callback', [CertificateFeeController::class, 'paymentCallback'])->name('certificates.paymentCallback');

Route::get('/certificates/thank-you/{certificateId}', [CertificateFeeController::class, 'thankYouPage'])->name('certificates.thankYouPage');

Route::post('/webinars/{id}/outdate', [WebinarController::class, 'outdate'])->name('webinars.outdate');

Route::post('/webinars/{id}/unoutdate', [WebinarController::class, 'unoutdate'])->name('webinars.unoutdate');
