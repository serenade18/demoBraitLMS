...
class ClassesController extends Controller
{
    ...
    {
        $webinarsQuery = Webinar::where('webinars.status', 'active' ) //this is the controller for status 
            ->where('private', false) //exclude private webinars
            ->where('outdated_course', 0); // Show only non-outdated courses
